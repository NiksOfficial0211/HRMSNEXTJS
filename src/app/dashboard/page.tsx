                                                ...
                                                <div className="grey_box" style={{ backgroundColor: "#fff" }} >
                                                    ...
                                                    {employeeData.map((employee) => (
                                                        <div className="row list_listbox" style={{ alignItems: "center", backgroundColor: employee.employment_status ? "#FFFFFF" : "#ed2024", cursor: "pointer" }} key={employee.emp_id} onClick={() => { navigateToProfile(employee.customer_id) }}>
                                                            ...
                                                            <div className="col-lg-2 text-center"><img src={employee.profile_pic != null && employee.profile_pic.length > 0 ? getImageApiURL + employee.profile_pic : staticIconsBaseURL+"images/attendance_profile_img.png"} className="img-fluid" style={{ maxHeight: "55px", borderRadius: "40px" }} /></div>
                                                                    ...
                                                                    <div className="col-lg-12 mb-2" key={index} onClick={() => {
                                                                        ...
                                                                        <div className="attendance_list">
                                                                            ...
                                                                            <div className="row" style={{ alignItems: "center" }}>
                                                                                <div className="col-lg-2 text-center"><img src={empAttendance.img_attachment?getImageApiURL+ empAttendance.img_attachment:staticIconsBaseURL+"/images/attendance_profile_img.png"} className="img-fluid" style={{ maxHeight: "60px", borderRadius: "40px" }} /></div>
