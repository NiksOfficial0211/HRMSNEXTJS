...
const AddBranchDetails = ({ onClose }: { onClose: (callUpdate:any) => void }) => {
            ...
            <form onSubmit={handleSubmit}>
                ...
                <div className="row">
                    <div className="col-md-6">
                        <div className="form_box mb-3">
                            <label htmlFor="exampleFormControlInput1" className="form-label">Branch Name<span className='req_text'>*</span> :  </label>
                            <input type="text" className="form-control" id="branch_number" value={formValues.branch_number} name="branch_number" onChange={handleInputChange} />
                ...
                <div className="row" style={{ alignItems: "center" }}>
                    <div className="col-md-6">
                        <div className="form_box mb-3">
                            ...
                            <input type="text" className="form-control" id="contact_details"
                                maxLength={12}
                                onKeyDown={(e) => {
                                ...
                                value={formValues.contact_details} name="contact_details" onChange={handleInputChange} />
                            {errors.contact_details && <span className="error" style={{ color: "red" }}>{errors.contact_details}</span>}
                        </div>
                    </div>
                    <div className="col-md-6">
