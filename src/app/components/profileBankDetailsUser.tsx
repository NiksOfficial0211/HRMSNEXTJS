                ...
                <div className="row">
                    <div className="col-lg-12">
                        ...
                        <div className="d_user_new_details_mainbox">
                            <div className="d_user_profile_heading">Bank Details</div>
                            <div className="d_user_profile_details_listing_box">
                                <div className="d_user_profile_details_listing">
                                    <div className="d_user_profile_details_subheading">Account No</div>
                                    <div className="d_user_profile_details_content">{bankDetails?.account_number || "--"}</div>
                                </div>
                                <div className="d_user_profile_details_listing">
                                    <div className="d_user_profile_details_subheading">Bank Name</div>
                                    <div className="d_user_profile_details_content">{bankDetails?.bank_name || "--"}</div>
                                </div>
                                <div className="d_user_profile_details_listing">
                                    <div className="d_user_profile_details_subheading">Branch Name</div>
                                    <div className="d_user_profile_details_content">{bankDetails?.branch_name || "--"}</div>
                                </div>
                                <div className="d_user_profile_details_listing">
                                    <div className="d_user_profile_details_subheading">IFSC code</div>
                                    <div className="d_user_profile_details_content">{bankDetails?.IFSC_code || "--"}</div>
                                </div>
                                <div className="d_user_profile_details_listing">
                        ...
                        <div className="d_user_new_details_mainbox">
                            <div className="d_user_profile_heading">Salary Details</div>
                            <div className="d_user_profile_details_listing_box">
                                <div className="d_user_profile_details_listing">
                                    <div className="d_user_profile_details_subheading">Gross Salary</div>
                                    <div className="d_user_profile_details_content">{totalSalaryDetails.gross_salary || "--"}</div>
                                </div>
                                <div className="d_user_profile_details_listing">
                                    <div className="d_user_profile_details_subheading">Total Deduction</div>
                                    <div className="d_user_profile_details_content">{totalSalaryDetails.total_deduction || "--"}</div>
                                </div>
                                <div className="d_user_profile_details_listing">
                                    <div className="d_user_profile_details_subheading">Net Pay</div>
                                    <div className="d_user_profile_details_content">{totalSalaryDetails.net_pay || "--"}</div>
                                </div>
                            </div>
                        </div>
                        {/* salary details ends */}
