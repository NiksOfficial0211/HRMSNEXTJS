...
//                     <img src="/images/user/40_profile13182025112.jpeg" alt="User Image" className="img-fluid" />
//                 </div>
//                 <div className="new_attendancebox_middlebox">
//                     <div className="new_attendance_middlebox_new_name">
//                         <h4>Hello Nikhil Tekawade</h4>
//                     </div>
...
//                             <div className="new_attendancebox_middlebox_first_listing_leftbox">
//                                 <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 32 32">
//                                     <path d="M15.87 31.814a13.56 13.56 0 1 1 9.588-23.142 1.13 1.13 0 0 1-1.598 1.598 11.3 11.3 0 1 0 0 15.98 1.13 1.13 0 0 1 1.598 1.598 13.514 13.514 0 0 1-9.588 3.966z" data-original="#424242" />
//                                     <path d="M21.52 25.04a1.13 1.13 0 0 1-.799-.33l-5.65-5.65a1.13 1.13 0 0 1-.331-.8v-7.91a1.13 1.13 0 0 1 2.26 0v7.443l5.319 5.318a1.13 1.13 0 0 1-.799 1.93z" data-original="#424242" />
//                                     <path fill="#fb2d2d" d="M30.56 19.39h-7.91a1.13 1.13 0 1 1 0-2.26h7.91a1.13 1.13 0 0 1 0 2.26z" data-original="#fbc02d" />
//                                     <path fill="#fb2d2d" d="M27.17 22.78a1.13 1.13 0 0 1-.799-1.929l2.593-2.59-2.585-2.592a1.13 1.13 0 0 1 1.598-1.598l3.39 3.39a1.13 1.13 0 0 1 0 1.598l-3.39 3.39a1.13 1.13 0 0 1-.807.331z" data-original="#fbc02d" />
//                                     <path d="M18.13 2.44h-4.52a1.13 1.13 0 0 1 0-2.26h4.52a1.13 1.13 0 0 1 0 2.26z" data-original="#424242" /></svg>
//                             </div>
//                             <div className="new_attendancebox_middlebox_first_listing_rightbox">
//                                 <div className="new_attendancebox_middlebox_first_listing_heading">Out time</div>
//                                 <div className="new_attendancebox_middlebox_first_listing_time">
//                                     {attendanceData.out_time! ? (
//                                         <span>
...
//                             <img src="/images/user/dashboard-background.png" alt='Attendance Image' className="dial_image img-fluid" />
//                         </div>
                ...
                <div className="new_attendancebox_middlebox">
                    ...
                    <div className="new_attendancebox_middlebox_first">
                        <div className="new_attendancebox_middlebox_first_listing_wfh">
                            ...
                            <div className="wfh_date_listing">
                                <div className="wfh_date_listing_content_day">{attendanceData.leap_working_type.type}</div>
                            </div>
                        </div>
                        <div className="new_attendancebox_middlebox_first_listing">
                            <div className="new_attendancebox_middlebox_first_listing_leftbox">
