...
const EmployeeLeaveList = () => {
    ...
    const fetchUsers = async (filterID: any, value: any, pageNumber: number, startDate: any, endDate: any,) => {
        ...
        try {
            ...
            formData.append("manager_id", contextCustomerID ||"3");
                                        ...
                                        <div className="col-lg-12">
                                            <div className="grey_box" style={{ backgroundColor: "#fff" }} >
                                                <div className="row list_label mb-4">
                                                    ...
                                                    <div className="col-lg-1 text-center"><div className="label">From</div></div>
                                                    ...
                                                    {leavearray?.map((applied) => (
                                                        <div className="row list_listbox" key={applied.id}>
                                                            ...
                                                            <div className="col-lg-1 text-center">{applied.from_date}</div>
                                                            <div className="col-lg-1 text-center">{applied.to_date}</div>
