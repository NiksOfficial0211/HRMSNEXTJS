                                                            ...
                                                            <div className={viewIndex == 1 ? "profile_selected_tab" : "profile_unselected_tab"}>
                                                                <span>
                                                                    <svg width="20" height="20" x="0" y="0" viewBox="0 0 24 24">
                                                                        <g>
                                                                            <path fill="#ffffff" fillRule="evenodd" d="M12 .25A8.75 8.75 0 0 0 3.25 9c0 1.052.379 2.275.915 3.5.544 1.243 1.284 2.563 2.076 3.833 1.585 2.54 3.417 4.937 4.42 6.202a1.704 1.704 0 0 0 2.679 0c1.002-1.265 2.834-3.662 4.419-6.203.792-1.27 1.532-2.59 2.076-3.832.536-1.225.915-2.448.915-3.5A8.75 8.75 0 0 0 12 .25zm0 4a4.25 4.25 0 1 0 0 8.5 4.25 4.25 0 0 0 0-8.5z" clipRule="evenodd" opacity="1" data-original="#000000"></path>
                                                                        </g>
                                                                    </svg>
                                                                </span>
                                                                <span> Address</span>
