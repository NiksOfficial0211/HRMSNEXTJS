...
export async function POST(request: NextRequest) {
    ...
    try {
        ...
        let query = supabase.from('leap_working_type')
            .select('id, type')
        ...
        return NextResponse.json({ status: 1, message: "Working type data fetched", data: AttendanceData }, { status: apiStatusSuccessCode })
