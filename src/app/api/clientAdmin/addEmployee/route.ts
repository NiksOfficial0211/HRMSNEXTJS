        ...
        let permanentAddress = supabase.from('leap_customer_address').insert([
            {
                client_id: insertCustomer[0].client_id,
                customer_id: insertCustomer[0].customer_id,
                address_line1: addressData.permanent.pcurrentAddressLineOne,
                address_line2: addressData.permanent.pcurrentAddressLineTwo,
                city: addressData.permanent.pcurrentCity,
                state: addressData.permanent.pcurrentState,
                postal_code: addressData.permanent.pcurrentPostalCode,
                country: addressData.permanent.pcurrentCountry,
