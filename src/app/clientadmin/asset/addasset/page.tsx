...
//         assetPicUrl.push(await fileUpload(formValues.asset_pic[0],"asset_pictures"));
//       }


//     } else if (formValues.vendor_bill != null) {
...
//                                     <input type="file" className="upload_document" multiple name="asset_pic" id="asset_pic" onChange={(e) =>{
...
//                   </div>
//                 </div>
//                 <div className='col-lg-4 p-0'><img src={"/images/add_asset_img.png"} className="img-fluid" /></div>
//               </div>
//             </div>
//           </form>
//         </div>
...
////// swapnil code on 16th april 2025
