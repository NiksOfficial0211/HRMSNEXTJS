...
//                                         </div>
//                                         {/* <div className="col-lg-5 announcement_switch_row">
//                                             <label htmlFor="formFile" className="form-label ">Show for specific Time Period:</label>
//                                             <label className="switch">
//                                                 <input type="checkbox" name="hasValidity" checked={announcementFormValues.hasValidity} onChange={handleInputChange} />
//                                                 <span className="slider round"></span>
//                                             </label>
//                                         </div> */}
//                                         <div className="col-lg-4 announcement_switch_row">
//                                             <label htmlFor="formFile" className="form-label">Disable:</label>
//                                             <label className="switch">
...
//                                         </div>
//                                         <div className="col-lg-4">
//                                         <label htmlFor="formFile" className="form-label">Delete Announcement:</label>
//                                         <img
//                                             src={`${staticIconsBaseURL}/images/delete.png`}
//                                             className="img-fluid"
//                                             style={{ maxHeight: '28px', cursor: 'pointer' }}
//                                             onClick={() => {
//                                                 // Set delete modal details
...
//                                         />
//                                         </div>
//                                         {ShowDeleteAnnouncementDialog && <DeleteConfirmation
//                                                                                 onClose={() => { setShowDeleteAnnouncementDialog(false), fetchData() }}
//                                                                                 id={AnnouncementDeleteID}
//                                                                                 deletionType={deleteDataTypeAnnouncement}
//                                                                                 deleteDetail={AnnouncementDeleteTitle}
//                                                                             />
//                                                                             }
//                                     </div>
